...
import {Card, CardHeader, CardText, CardBody, CardFooter, Button, Spinner,
...
class MoviePage extends Component {
  ...
  render() {
    ...
    const {id, title, director, actors, writers, plot, year, genres, 
      num_of_ratings, avg_rating, countries, reviews, user_rating, loaded} = this.state;
    ...
    return (
          ...
          <Card body inverse style={{ backgroundColor: '#E4E4E4', color: '#232323'}}>
            ...
            <CardBody>
              <CardText style={{ color: '#232323'}}>
                ...
                Genres: {genres.map(genre => genre.name).join(", ") }<br />
                Plot: {plot}
              </CardText>
            </CardBody>
        ...
        : <Spinner color='dark' className='spinn' />}
        </div>
    )
  }
}
