...
import {Button, Container, Row, Col, ListGroup, ListGroupItem,
    Nav, NavItem, NavLink, TabContent, TabPane, Spinner} from "reactstrap";
...
export default class UserMvInfo extends Component {
    ...
    render(){
        const {last_name, first_name, email, photo, ratings, 
            reviews, avgRate, numOfWtchd, edit, activeTab, loaded} = this.state;
